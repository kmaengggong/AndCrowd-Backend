...
class CrowdControllerTest {
    ...
    void deleteCrowdTest() throws Exception {
        ...
        // when
        final ResultActions resultActions = mockMvc.perform(get(url2).accept(MediaType.APPLICATION_JSON));
        // then
//        List<CrowdDTO.FindAllByUserId> afterCrowdList = crowdJPARepository.findAllByUserId(crowdId);
//        assertEquals(2, afterCrowdList.size());
    }
}