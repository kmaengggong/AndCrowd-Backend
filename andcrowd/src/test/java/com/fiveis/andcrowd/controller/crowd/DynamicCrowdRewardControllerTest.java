...
class DynamicCrowdRewardControllerTest {
    ...
    void deleteDynamicReward() throws Exception {
        ...
        // then
//        List<DynamicCrowdRewardDTO.FindAllById> afterRewardList = dynamicCrowdRewardRepository.findAll(crowdId);
//        assertEquals(2, afterRewardList.size());
        assertThat(dynamicCrowdRewardRepository.findByRewardId(crowdId, rewardId).isDeleted()).isTrue();
    }
}